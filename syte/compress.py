...
def compress_statics():
    try:
        ...
        print 'Make sure to create "syte > static > css" ' \
                'and "syte > static > js > min" before compressing statics.'
...
def compress_js():
    js_files = (
        ...
        ('js/components/tent', settings.TENT_INTEGRATION_ENABLED),
        ('js/components/steam', settings.STEAM_INTEGRATION_ENABLED),
        ('js/components/stackoverflow',
         settings.STACKOVERFLOW_INTEGRATION_ENABLED),
